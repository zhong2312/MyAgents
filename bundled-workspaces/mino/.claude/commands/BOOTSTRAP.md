...
- `.claude/rules/01-IDENTITY.md` — your name, creature, vibe, emoji
- `.claude/rules/03-USER.md` — their name, how to address them, timezone, notes

Then open `.claude/rules/02-SOUL.md` together and talk about:
