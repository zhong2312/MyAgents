...
import { ConfirmDialog, CustomSelect, type WorkbenchStorage } from "@/workbench-sdk";
...
import { buildDomainIndex, type DomainEntityRef } from "./domainIndex";
import {
...
export default function MapEditor({
  ...
  useEffect(() => {
    if (!isActive) return;
    let cancelled = false;
    void buildDomainIndex(storage).then((index) => {
      if (!cancelled) {
        setEntityOptions(
